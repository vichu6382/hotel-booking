...
const NewsLetter = () => {
  return (
    <div className="flex flex-col items-center w-full max-w-5xl lg:w-full rounded-2xl px-5 py-16 md:py-19 mx-2 lg:mx-auto my-10 bg-gray-900 text-white">
      <Title
        title={"Stay Inspired"}
        subTitle={
          "Lorem ipsum dolor sit amet repudiandae quasi asperiores provident corporis voluptatibus"
        }
      />
